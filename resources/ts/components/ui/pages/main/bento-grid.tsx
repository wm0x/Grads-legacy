  ...
  >
    ...
    <div className="p-4">
      ...
      >
        ...
        >
          <a href={href} className="text-green-700">
            {cta}
    ...
    <div
      className={cn(
        "hidden lg:flex pointer-events-none text-green-700 absolute bottom-0 w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100",
      )}
    >
      <Button
        variant="link"
