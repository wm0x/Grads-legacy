...
import { AuroraText } from "../login/ui/aurora-text";
import z from "zod";
import { NewUser } from "../../../../../schema/auth/auth";
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <LabelInputContainer>
                          <Label htmlFor="name" className="text-white ml-2 font-bold">
                            name
                          </Label>
                          <Input
                            {...field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <LabelInputContainer>
                          <Label htmlFor="username" className="text-white ml-2 font-bold">
                            username
                          </Label>
                          <Input
                            disabled={isPending}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormControl>
                        <LabelInputContainer>
                          <Label htmlFor="email" className="text-white ml-2 font-bold">
                            email
                          </Label>
                          <Input
                            disabled={isPending}
                    ...
                    <FormItem>
                      <FormControl>
                        <LabelInputContainer className="relative">
                          <Label htmlFor="password" className="text-white ml-2 font-bold">
                            password
                          </Label>
                          <Input
                            disabled={isPending}
